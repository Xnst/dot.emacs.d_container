;;; nyWombat-theme.el --- Custom face theme for Emacs
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:background "#a5c565"))))
   ;; Highlighting faces
   `(fringe ((,class (:background "#303030"))))
   `(highlight ((,class (:background "#658545" :foreground "#ffffff"
			 :underline t))))
   `(region ((,class (:background "#546444" :foreground "#f6f3e8"))))
   ...
   ;; Mode line faces
   `(mode-line ((,class (:background "#344424" :foreground "#f6f3e8"))))
   `(mode-line-inactive ((,class (:background "#857b6f" :foreground "#242424"))))
   ...
   ;; Outline faces, mostly for org-mode
   `(outline-1 ((,class (:foreground "#cae682" :weight bold))))
   `(outline-2 ((,class (:foreground "#f5887d" :weight bold))))
   `(outline-3 ((,class (:foreground "#c99999" :weight bold))))
   `(outline-4 ((,class (:foreground "orchid"))))
   `(outline-5 ((,class (:foreground "orchid"))))
   ;; company mode color
   '(company-tooltip ((t (:inherit nil :background "grey23" :foreground "white"))))
   `(company-scrollbar-bg ((t (:background "red4"))))
   `(company-scrollbar-fg ((t (:background "DarkOrange4"))))
   `(company-tooltip-selection ((t (:inherit font-lock-function-name-face))))
   `(company-tooltip-common ((t (:inherit font-lock-constant-face))))
   ;; Message faces
   `(message-header-name ((,class (:foreground "#cd5c5c" :weight bold))))
...
(provide-theme 'nyWombat)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; nyWombat-theme.el ends here
